...
class _$ProductImpl implements _Product {
  _$ProductImpl(
      ...
      @JsonKey(name: 'RetailPrice') required this.retailPrice,
      @JsonKey(name: 'Brand') this.brand,
      @JsonKey(name: 'Images') final List<ImageModel>? images,
...
abstract class _Product implements Product {
  factory _Product(
      ...
      @JsonKey(name: 'RetailPrice') required final int retailPrice,
